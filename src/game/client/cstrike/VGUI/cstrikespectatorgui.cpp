...
CCSMapOverview::CCSMapOverview( const char *pElementName ) : BaseClass( pElementName )
{
	...
	SetMapOverView(0,this);  // for cvars access etc
...
void CCSMapOverview::SetMode(int mode)
{
	if ( mode == MAP_MODE_RADAR )
	{
		...
		GetClientMode()->GetViewportAnimationController()->RunAnimationCommand( this, "zoom", desiredZoom, 0.0, 0, vgui::AnimationController::INTERPOLATOR_LINEAR );
